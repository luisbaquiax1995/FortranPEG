...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { Calculator: peg$parseCalculator };
  var peg$startRuleFunction = peg$parseCalculator;
  ...
  var peg$e5 = peg$otherExpectation("integer");
